...
public class AnyRequirementTests
{
    [Fact]
    public void Constructor_SavesRequirements()
    {
        ...
        var all = new AnyRequirement([requirementOne, requirementTwo]);
    ...
    public void Constructor_WithSingleArgThrows()
    {
        ...
        Assert.Throws<ArgumentException>(() => new AnyRequirement([requirementOne]));
    }
}
